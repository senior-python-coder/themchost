...
<div class="online"><span class="pulse-dot"></span><span>👥 Online: <strong id="onlineCount"></strong>/2026</span></div>
</div>
</header>
<div class="container">
    ...
    for payment in payments:
        if payment['id'] == payment_id:
            ...
            if new_status == 'approved':
                ...
                if success:
                    return jsonify({'success': True,
                                    'message': f'✅ Tasdiqlandi! {payment["nickname"]} ga {payment["rank"]} ranki RCON orqali berildi!'})
                else:
                    return jsonify({'success': True,
                                    'message': f'⚠️ Tasdiqlandi! Ammo RCON ulanmadi. Commandlar rank_commands.txt faylida.'})
